...
export default function DashboardCard({ title, value, icon: Icon, iconColor, delay = 0 }: DashboardCardProps) {
  return (
    <motion.div
    ...
    >
      <div className="min-w-0">
        ...
        <p className="text-2xl font-extrabold text-foreground tracking-tight mt-1">{value}</p>
      </div>
